...
public class MySecondSoapTest {

    private String testCaseName;
    private static String soapuiProjectName = "src/test/resources/TestProjectEclipse-soapui-project.xml";

    public MySecondSoapTest(String testCaseName) {
    ...
    public static Collection<String[]> getTestCases() throws XmlException, IOException, SoapUIException {
        ...
        WsdlTestSuite wsdlTestSuite = soapuiProject.getTestSuiteByName("CalculatorSoap TestSuite");
    ...
    public static boolean runSoapUITestCase(String testCase) throws XmlException, IOException, SoapUIException {
        ...
        WsdlProject soapuiProject = new WsdlProject(soapuiProjectName);
        WsdlTestSuite testSuite = soapuiProject.getTestSuiteByName("CalculatorSoap TestSuite");
        if (testSuite == null) {
